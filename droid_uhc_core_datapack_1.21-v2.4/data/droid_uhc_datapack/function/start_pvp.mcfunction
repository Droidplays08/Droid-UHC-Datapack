...
team leave @a
scoreboard players set droid.game_state_pvp droid_uhc_game_data 1

execute if score droid.worldborder_size droid_uhc_game_data matches 500 if score droid.game_duration droid_uhc_game_data matches 60 run worldborder add -471 1800
execute if score droid.worldborder_size droid_uhc_game_data matches 500 if score droid.game_duration droid_uhc_game_data matches 30 run worldborder add -471 1200
execute if score droid.worldborder_size droid_uhc_game_data matches 1000 if score droid.game_duration droid_uhc_game_data matches 60 run worldborder add -971 1800
execute if score droid.worldborder_size droid_uhc_game_data matches 1000 if score droid.game_duration droid_uhc_game_data matches 30 run worldborder add -971 1200
...
execute if score droid.game_duration droid_uhc_game_data matches 30 run bossbar set timer max 24000
...
execute if score droid.game_duration droid_uhc_game_data matches 30 run scoreboard players set droid.timerC droid_uhc_game_data 24000
