...
execute if score droid.game_duration droid_uhc_game_data matches 60 run effect give @s haste 1800 1 true
execute if score droid.game_duration droid_uhc_game_data matches 30 run effect give @s haste 600 1 true
