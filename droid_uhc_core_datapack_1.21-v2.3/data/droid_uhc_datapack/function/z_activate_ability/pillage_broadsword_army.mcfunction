...
scoreboard players reset droid pillage_army_type
execute if predicate droid_uhc_addon_1_21:25_chance run scoreboard players set droid pillage_army_type 1
execute if predicate droid_uhc_addon_1_21:25_chance run scoreboard players set droid pillage_army_type 2
execute if predicate droid_uhc_addon_1_21:25_chance run scoreboard players set droid pillage_army_type 3
execute unless score droid pillage_army_type matches 1..3 run scoreboard players set droid pillage_army_type 4
...
execute if score droid pillage_army_type matches 2 at @s run summon vindicator ~1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 2 at @s run summon vindicator ~-1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 2 at @s run summon pillager ~ ~ ~1 {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:20,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:crossbow,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:20f}]}
execute if score droid pillage_army_type matches 2 at @s run summon pillager ~ ~ ~-1 {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:20,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:crossbow,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:20f}]}
execute if score droid pillage_army_type matches 2 at @s run summon ravager ~ ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:40,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,attributes:[{id:"generic.max_health",base:40f}]}

execute if score droid pillage_army_type matches 3 at @s run summon vindicator ~ ~ ~1 {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 3 at @s run summon vindicator ~ ~ ~-1 {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 3 at @s run summon ravager ~1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:40,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,attributes:[{id:"generic.max_health",base:40f}]}
execute if score droid pillage_army_type matches 3 at @s run summon ravager ~-1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:40,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,attributes:[{id:"generic.max_health",base:40f}]}

execute if score droid pillage_army_type matches 4 at @s run summon vindicator ~ ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 4 at @s run summon vindicator ~ ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:10,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:iron_axe,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:10f}]}
execute if score droid pillage_army_type matches 4 at @s run summon pillager ~1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:20,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:crossbow,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:20f}]}
execute if score droid pillage_army_type matches 4 at @s run summon pillager ~-1 ~ ~ {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:20,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:crossbow,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:20f}]}
execute if score droid pillage_army_type matches 4 at @s run summon pillager ~ ~ ~1 {CustomName:'[{"text":"Illager Uprisers","color":"dark_gray"}]',Health:20,PersistenceRequired:1b,Tags:["time_lived","pillage_army"],Team:pillage_broadsword_army,HandItems:[{id:crossbow,count:1}],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:20f}]}
