...
function droid_uhc_addon_1_21:z_others/starter_kit/starter_kit_check
...
execute as @a[tag=default_glider_aqua] run function droid_uhc_addon_1_21:z_wear_default_glider/wear_default_glider_aqua
execute as @a[tag=default_glider_leaf] run function droid_uhc_addon_1_21:z_wear_default_glider/wear_default_glider_leaf
execute as @a[tag=default_glider_cloud] run function droid_uhc_addon_1_21:z_wear_default_glider/wear_default_glider_cloud
execute as @a[tag=default_glider_dragon] run function droid_uhc_addon_1_21:z_wear_default_glider/wear_default_glider_dragon
execute as @a[tag=default_glider_plane] run function droid_uhc_addon_1_21:z_wear_default_glider/wear_default_glider_plane

execute as @a run function droid_uhc_addon_1_21:z_others/check_for_glider
...
function droid_uhc_addon_1_21:join_friendly_mob
