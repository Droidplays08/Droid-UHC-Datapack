...
execute as @a[scores={giant_battle_axe_timer=300}] run function droid_uhc_addon_1_21:z_activate_ability/stop_giant_battle_axe
execute as @a[scores={giant_battle_axe_timer=310..},nbt={OnGround:1b}] run function droid_uhc_addon_1_21:z_activate_ability/stop_giant_battle_axe_2
...
scoreboard players set droid number_data 20
execute as @a[tag=using_giant_battle_axe] run scoreboard players operation @s giant_battle_axe_extra_data %= droid number_data
execute as @a[scores={giant_battle_axe_extra_data=0}] run function droid_uhc_addon_1_21:z_activate_ability/giant_battle_axe_step

execute as @a[scores={mercury_dagger_timer=300}] run function droid_uhc_addon_1_21:z_activate_ability/stop_mercury_dagger

execute as @e[type=arrow,tag=frosted_spear_projectile] at @s run execute as @e[tag=!frosted_spear_projectile,tag=!using_frosted_spear_shoot,distance=..3,tag=!frosted_spear_minion,type=!#droid_uhc_addon_1_21:non_mob_entity] at @s run summon marker ~ ~ ~ {Tags:["time_lived","frosted_spear_shoot_marker","not_placed_snow"]}
...
execute as @e[type=marker,tag=frosted_spear_shoot_marker] at @s if block ~ ~ ~ #droid_uhc_addon_1_21:ender_blade_allow_tp_block_list run particle minecraft:snowflake ~ ~0.5 ~ 0.2 0.2 0.2 0.001 20
execute as @e[type=marker,tag=frosted_spear_shoot_marker] at @s if block ~ ~1 ~ #droid_uhc_addon_1_21:ender_blade_allow_tp_block_list run particle minecraft:snowflake ~ ~1.5 ~ 0.2 0.2 0.2 0.001 20
...
execute if score droid game_state_pvp matches 1 as @a[scores={frosted_spear_shoot_extra_data=0}] at @s as @e[type=marker,tag=frosted_spear_shoot_marker,distance=..30] at @s as @e[distance=..2,tag=!using_frosted_spear_shoot,tag=!using_frosted_spear_minion,tag=!frosted_spear_minion] run damage @s 1 freeze by @p[tag=using_frosted_spear_shoot]
execute if score droid game_state_pvp matches 0 as @a[scores={frosted_spear_shoot_extra_data=0}] at @s as @e[type=marker,tag=frosted_spear_shoot_marker,distance=..30] at @s as @e[distance=..2,tag=!using_frosted_spear_shoot,tag=!using_frosted_spear_minion,tag=!frosted_spear_minion,type=!player] run damage @s 1 freeze by @p[tag=using_frosted_spear_shoot]
...
execute as @e[type=marker,tag=frosted_spear_shoot_marker,scores={time_lived=200..}] run function droid_uhc_addon_1_21:z_activate_ability/stop_frosted_spear_marker
execute as @a[scores={frosted_spear_shoot_timer=200}] run function droid_uhc_addon_1_21:z_activate_ability/stop_frosted_spear_shoot

execute as @a[scores={frosted_spear_minion_timer=300}] run function droid_uhc_addon_1_21:z_activate_ability/stop_frosted_spear_minion
...
execute as @a[scores={pillage_broadsword_army_timer=400}] run function droid_uhc_addon_1_21:z_activate_ability/stop_pillage_broadsword_army
...
scoreboard players set droid number_data 4
execute as @a[tag=using_wind_cannon_dash] run scoreboard players operation @s wind_cannon_dash_extra_data %= droid number_data
execute as @a[scores={wind_cannon_dash_extra_data=0}] run function droid_uhc_addon_1_21:z_activate_ability/wind_cannon_summon_wind_charge
execute as @a[scores={wind_cannon_dash_timer=12}] run function droid_uhc_addon_1_21:z_activate_ability/stop_wind_cannon_dash
...
execute as @a[scores={wind_cannon_tornado_timer=100}] run function droid_uhc_addon_1_21:z_activate_ability/stop_wind_cannon_tornado
...
execute as @e[type=ravager,tag=ravager_charge] at @s if block ^ ^1 ^ #minecraft:leaves run setblock ^ ^1 ^ air destroy
execute as @e[type=ravager,tag=ravager_charge] at @s if block ^ ^-1 ^ #minecraft:leaves run setblock ^ ^-1 ^ air destroy
execute as @e[type=ravager,tag=ravager_charge] at @s anchored eyes unless block ^ ^ ^1 #droid_uhc_addon_1_21:ender_blade_allow_tp_block_list unless block ^ ^ ^1 #minecraft:leaves run function droid_uhc_addon_1_21:z_activate_ability/ravager_charge_explode
execute as @e[type=ravager,tag=ravager_charge] at @s if entity @n[distance=..0.5,tag=!using_pillage_broadsword_shoot,tag=!ravager_charge] run function droid_uhc_addon_1_21:z_activate_ability/ravager_charge_explode
...
execute as @a[scores={ender_blade_timer=1..}] run function droid_uhc_addon_1_21:z_activate_ability/stop_ender_blade

execute if score droid game_state_pvp matches 0 at @a[scores={hephaestus_spear_cd=100..}] as @e[type=fireball,tag=fireball,distance=..5] run kill @s
execute if score droid game_state_pvp matches 0 at @a[scores={zeus_blowgun_cd=100..}] as @e[type=arrow,tag=zeus_arrow,distance=..5] run kill @s
