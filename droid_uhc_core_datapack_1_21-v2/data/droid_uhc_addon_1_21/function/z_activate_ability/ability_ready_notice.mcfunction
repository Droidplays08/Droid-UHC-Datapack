...
execute as @a[scores={dragon_halberd_shoot_cd=600}] run function droid_uhc_addon_1_21:z_activate_ability/ready_notice/dragon_halberd_shoot
execute as @a[scores={dragon_halberd_yeet_cd=1200}] run function droid_uhc_addon_1_21:z_activate_ability/ready_notice/dragon_halberd_yeet

execute as @a[scores={pillage_broadsword_army_cd=2400}] run function droid_uhc_addon_1_21:z_activate_ability/ready_notice/pillage_broadsword_army
execute as @a[scores={pillage_broadsword_shoot_cd=800}] run function droid_uhc_addon_1_21:z_activate_ability/ready_notice/pillage_broadsword_shoot
