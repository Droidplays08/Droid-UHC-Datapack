...
execute if score droid game_state_pvp matches 1 at @e[tag=spawn_cobweb] run effect give @e[tag=!using_spider_katana,distance=..1.5] poison 7 1 true
execute if score droid game_state_pvp matches 0 at @e[tag=spawn_cobweb] run effect give @e[tag=!using_spider_katana,distance=..1.5,type=!player] poison 7 1 true
