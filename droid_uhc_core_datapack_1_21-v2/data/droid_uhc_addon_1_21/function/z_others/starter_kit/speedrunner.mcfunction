...
execute if score droid game_duration matches 60 run effect give @s speed 1800 0 true
execute if score droid game_duration matches 30 run effect give @s speed 600 0 true
