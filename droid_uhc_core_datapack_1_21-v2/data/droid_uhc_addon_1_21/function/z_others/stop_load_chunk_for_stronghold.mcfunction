...
tellraw @a {"text":"Admin can right-click the Start Icon or type /function droid_uhc_addon_1_21:start_game_countdown to begin!","color":"aqua"}
...
function droid_uhc_addon_1_21:z_others/spawn_end_portal