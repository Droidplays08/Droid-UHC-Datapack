function droid_uhc_addon_1_21:reset_deathcount
function droid_uhc_addon_1_21:worldborder_500
...
function droid_uhc_addon_1_21:z_others/limit_mob_cap

function droid_uhc_addon_1_21:spawn_pre_game_chamber
