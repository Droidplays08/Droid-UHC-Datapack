...
#execute as @e[tag=!friendly_mob,tag=!pillage_army,tag=!frosted_spear_minion,tag=!structure_mob] run function droid_uhc_datapack:join_friendly_mob
...
execute if score droid timer matches 0..201 run function droid_uhc_datapack:z_others/start_game_countdown
...
execute if score droid game_on matches 1 if score droid remaining_player matches ..1 run function droid_uhc_datapack:z_others/end_game

execute if score droid game_duration matches 60 if score droid timerB matches 36000 run function droid_uhc_datapack:start_pvp
execute if score droid game_duration matches 60 if score droid timerB matches 72000 run function droid_uhc_datapack:overtime

execute if score droid game_duration matches 30 if score droid timerB matches 12000 run function droid_uhc_datapack:start_pvp
execute if score droid game_duration matches 30 if score droid timerB matches 36000 run function droid_uhc_datapack:overtime

execute as @a if score droid random_legendary_at_mid_preperation matches 1 if score droid game_duration matches 60 if score droid timerB matches 18000 run function droid_uhc_datapack:z_others/give_random_legendary
execute as @a if score droid random_legendary_at_mid_preperation matches 1 if score droid game_duration matches 30 if score droid timerB matches 6000 run function droid_uhc_datapack:z_others/give_random_legendary
...
execute if score droid reduced_ability_cooldown matches 1 run function droid_uhc_datapack:z_activate_ability/ability_cd_timer
...
execute if score droid game_on matches 1 run function droid_uhc_datapack:z_activate_ability/ability_ready_notice

#execute as @e[type=item,nbt={Item:{id:"minecraft:player_head",count:1}}] at @s run function droid_uhc_datapack:z_others/generate_kill_token
...
execute if score droid entered_end matches 1 if score droid timer-enter_end matches 80 as @a at @s run function droid_uhc_datapack:z_others/enter_end

execute if score droid dragon_dead matches 0 as @a[advancements={minecraft:end/kill_dragon=true}] run function droid_uhc_datapack:z_others/kill_dragon
...
execute if score droid fill_end_portal matches 1 run function droid_uhc_datapack:z_others/leave_end/fill_end_portal

execute as @a[tag=!ready_leave_end] at @s if dimension minecraft:the_end if score droid fill_end_portal matches 2 if block ~ ~-1 ~ bedrock unless entity @e[type=minecraft:ender_dragon] run function droid_uhc_datapack:z_others/leave_end/ready_leave_end
execute as @a[tag=ready_leave_end] at @s if dimension minecraft:the_end if score droid fill_end_portal matches 2 unless block ~ ~-1 ~ bedrock unless entity @e[type=minecraft:ender_dragon] run function droid_uhc_datapack:z_others/leave_end/cancel_leave_end
...
execute if score droid game_on matches 1 run function droid_uhc_datapack:z_others/disconnect/disconnect_add_counter
execute if score droid game_on matches 1 run function droid_uhc_datapack:z_others/disconnect/disconnect_check
...
execute if score droid load_chunk_for_stronghold matches 1 as @a[tag=admin,scores={load_chunk_for_stronghold=801}] run function droid_uhc_datapack:z_others/stop_load_chunk_for_stronghold
...
execute if score droid load_chunk_for_lobby matches 1 as @a[tag=admin,scores={load_chunk_for_lobby=201}] run function droid_uhc_datapack:z_others/spawn_lobby
